...
export function CustomSignIn() {
  ...
  const [error, setError] = useState<string | null>(
    initialUrlError === "access_denied"
      ? "Access denied. You must be an invited admin to sign in."
      : null,
  );
  ...
  return (
    <div className="mx-auto w-full max-w-sm space-y-6">
      <div className="space-y-2 text-center">
        <Logo className="mx-auto mb-4 h-12 w-auto text-foreground" />
      ...
      <div className="space-y-4">
        {error && (
          <div className="rounded-md border border-red-100 bg-red-50 p-3 text-sm text-red-600 dark:border-red-900/50 dark:bg-red-950/30 dark:text-red-400">
            {error}
          </div>
        )}
