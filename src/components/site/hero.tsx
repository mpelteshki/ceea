  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,color-mix(in_oklch,var(--brand-teal)_10%,transparent),transparent)]" />
      ...
      <div className="ui-site-container relative">
        <div className="flex flex-col items-center pt-32 pb-24 text-center sm:pt-40 sm:pb-32">
          {/* Heading — CSS animations so text is in initial HTML (no JS needed for LCP) */}
          <div className="flex flex-col items-center gap-6 animate-[hero-fade-in_0.8s_cubic-bezier(0.22,1,0.36,1)_both]">
            <h1 className="font-display text-[clamp(2.5rem,7vw,6rem)] font-bold leading-[1.05] tracking-[-0.03em] text-balance text-foreground sm:leading-[1.02] sm:tracking-[-0.04em] max-w-5xl mx-auto">
              <span className="block animate-[hero-slide-up_0.8s_cubic-bezier(0.22,1,0.36,1)_both]">
                Central &amp; Eastern European
              </span>
              <span className="block pb-2 relative animate-[hero-slide-up_0.8s_0.15s_cubic-bezier(0.22,1,0.36,1)_both]">
          ...
          {/* Decorative line */}
          <div
            className="mt-8 h-[2px] w-full max-w-[120px] mx-auto origin-left animate-[hero-line_0.8s_0.4s_cubic-bezier(0.22,1,0.36,1)_both]"
            style={{ background: "var(--brand-teal)" }}
          />

          {/* Body + CTA */}
          <div className="mt-8 flex flex-col items-center gap-8 animate-[hero-slide-up_0.8s_0.5s_cubic-bezier(0.22,1,0.36,1)_both]">
