      ...
      <div>
        <div className="mx-auto flex h-16 max-w-[80rem] items-center justify-between px-5 sm:px-6">
          <div className="flex shrink-0 items-center justify-center gap-2 sm:gap-3">
            ...
            <span className="hidden font-display text-lg font-bold tracking-tight sm:block">Admin</span>
          </div>

          <nav aria-label="Admin Primary" className="hidden items-center gap-1 lg:flex">
            {ITEMS.map((l) => (
            ...
            <div className="px-5 pt-5 pb-[calc(1.25rem+env(safe-area-inset-bottom,0px))]">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3">
                  <Link href="/" onClick={closeMenu} className="group flex h-8 w-8 items-center justify-center rounded-full border border-border bg-card text-muted-foreground transition-colors hover:border-[var(--ring)] hover:text-foreground">
                    <span className="sr-only">Back to site</span>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 3.5L2 8L6.5 12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M2.5 8H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </Link>
